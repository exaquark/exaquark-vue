...
//   const spread = 0.01
//   const SG_LAT = 1.288317
//   const SG_LNG = 103.847512
//   let mockBots = []
//   for (var i = 0; i < 12; i++) {
//     // make some fake location data
//     let lat = SG_LAT + (Math.random() - 0.5) * spread
//     let lng = SG_LNG + (Math.random() - 0.5) * spread
//     mockBots.push({
...
//       geo: {
//         lat: lat, // {double} required: latitude
//         lng: lng, // {double} required: longitude
